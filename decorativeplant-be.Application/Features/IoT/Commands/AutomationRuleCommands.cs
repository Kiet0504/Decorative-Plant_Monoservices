...
public class CreateAutomationRuleCommandHandler : IRequestHandler<CreateAutomationRuleCommand, AutomationRuleDto>
{
    ...
    public CreateAutomationRuleCommandHandler(IIotRepository repo) => _repo = repo;
...
{
    private readonly IIotRepository _repo;
    public UpdateAutomationRuleCommandHandler(IIotRepository repo) => _repo = repo;
...
{
    private readonly IIotRepository _repo;
    public DeleteAutomationRuleCommandHandler(IIotRepository repo) => _repo = repo;
