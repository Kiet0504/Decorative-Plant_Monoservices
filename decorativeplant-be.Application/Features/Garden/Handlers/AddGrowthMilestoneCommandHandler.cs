...
public class AddGrowthMilestoneCommandHandler : IRequestHandler<AddGrowthMilestoneCommand, GrowthMilestoneDto>
{
    private readonly IGardenRepository _gardenRepository;
    private readonly IUnitOfWork _unitOfWork;

    public AddGrowthMilestoneCommandHandler(
    ...
    public async Task<GrowthMilestoneDto> Handle(AddGrowthMilestoneCommand request, CancellationToken cancellationToken)
    {
        ...
        var milestone = new GrowthMilestoneDto
        {
            Id = Guid.NewGuid(),
            Type = request.Type,
        ...
        plant.Details = GardenPlantMapper.AddMilestone(plant.Details, milestone);
